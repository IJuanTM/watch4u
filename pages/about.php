...
<div class="about container">
    <div class="row">
        ...
        <div class="col-12 col-md-9">
            ...
            <div class="row">
                ...
                <div class="col-10 col-lg-8">
                    <a href="https://github.com/IJuanTM/Watch4U" target="_blank" class="btn btn-dark about-btn btn-lg active" role="button" aria-pressed="true">Check out the site on GitHub! <i class="fab fa-lg fa-github"></i></a>
                </div>
                <div class="col-1 col-lg-2"></div>
            </div>
        ...
        <div class="col-0 col-md-3 about-extra">
            ...
            <img class="about-img" src="./img/logo/Watch4U.svg">
            ...
            <ul class="list-unstyled">
                <li class="role">Website Design & Product Listings:</li>
                <h6>Iwan van der Wal</h6>
                <li class="role">Php Scripts & Database:</li>
                <h6>Richard van de Kooij</h6>
            </ul>
