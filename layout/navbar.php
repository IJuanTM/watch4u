        ...
        <ul class="navbar-nav ml-auto">
            ...
            if (!empty($userrole)) {
                switch ($_SESSION["userrole"]) {
                    case 'Root':
                        echo '<li class="nav-item"><a class="nav-link" href="https://web0116.zxcs.nl/phpmyadmin/db_structure.php?server=1&db=u37477p32749_watch4u" target="_blank"><i class="fas fa-database"></i> <span class="mobile">Database</span></a></li>';
